...
**NOTE:** 
The visualizations for this project were performed using the Cufflinks Python library, which allows for the creation of **interactive charts**. To view them, you need to download [Jupyter Notebook](https://github.com/diogosmferreira/COVID-19/blob/main/COVID-19%20Exploratory%20Data%20Analysis%20and%20Visualizations.ipynb) and run the code, or download the [HTML](https://github.com/diogosmferreira/COVID-19/blob/main/COVID-19%20Exploratory%20Data%20Analysis%20and%20Visualizations.html) version.
